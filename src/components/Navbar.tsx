...
import { Sun, Moon, Sparkles, Menu, X, FileText, Send, BarChart2 } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        {/* Right Side Actions: Snapshot, Dark Mode & CTA */}
        <div className="flex items-center gap-2 sm:gap-3">
          {/* Recruiter Quick Snapshot Button */}
          <button
            id="recruiter-quick-view-btn"
            onClick={onOpenRecruiterSnapshot}
            className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-blue-700 dark:text-blue-300 bg-blue-50 dark:bg-blue-950/70 hover:bg-blue-100 dark:hover:bg-blue-900/50 border border-blue-200 dark:border-blue-800/80 rounded-lg transition-all shadow-xs"
        ...
        >
          ...
          <div className="pt-2 border-t border-slate-200 dark:border-slate-800 flex flex-col gap-2">
            ...
            >
              ...
              Recruiter Quick-View (30s Brief)
            </button>
          </div>
        </div>
      )}
